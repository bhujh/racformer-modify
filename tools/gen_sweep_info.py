...
parser.add_argument('--data-root', default='/mnt/diskNvme1/dataset/nuscenes')
parser.add_argument('--version', default='v1.0-trainval')

# parser.add_argument("--data-root", default="/mnt/diskNvme1/dataset/nuscenes_mini")
...
if __name__ == '__main__':
    ...
    if args.version == 'v1.0-trainval':
        ...
        # print(sample_infos)
        # print(sample_infos['metainfo'].keys())
        # print(sample_infos['metainfo']['dataset'])
        # print(sample_infos['metainfo']['info_version'])


        # print(len(sample_infos['data_list']))
        # print(sample_infos['data_list'][0].keys())
        # os.abort()
